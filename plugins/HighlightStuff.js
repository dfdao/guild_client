...
const PLUGIN_NAME = "Highlight Interesting Stuff";
...
const filterAlwaysTrue = (plugin, planet) => {
  return distanceAndLevelInRange(plugin, planet) && planetTypeMatches(plugin, planet)
}
...
class Plugin {
  constructor() {
    ...
    this.highlightData = {
      alwaysTrue: {label: "Always true", filter: filterAlwaysTrue, array: [TOGGLE_OFF], periodMs: periodMsHighlight2xSpeed, cols: colsHighlight2xSpeed},
    };
