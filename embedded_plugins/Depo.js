        ...
        for (shift2 = a_l - b_l; shift2 >= 0; shift2--) {
          ...
          if (remainder[shift2 + b_l] !== divisorMostSignificantDigit) {
            quotientDigit = Math.floor(
              (remainder[shift2 + b_l] * base + remainder[shift2 + b_l - 1]) /
...
var require_address = __commonJS({
  "node_modules/@darkforest_eth/serde/dist/address.js"(exports) {
    ...
    function hashToInt(hash) {
      const seed = (0, big_integer_1.default)(hash, 16)
        .and(1099511627775)
        .toString(16);
...
var require_artifact = __commonJS({
  "node_modules/@darkforest_eth/types/dist/artifact.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.artifactNameFromArtifact =
...
var require_dist2 = __commonJS({
  "node_modules/@darkforest_eth/constants/dist/index.js"(exports) {
    ...
    exports.HAT_SIZES =
      exports.SpecialKey =
      exports.PLANET_CLAIM_MIN_LEVEL =
      exports.RECOMMENDED_MODAL_WIDTH =
      exports.GAS_PRICES_INTERVAL_MS =
      exports.BLOCK_EXPLORER_URL =
      exports.MAX_AUTO_GAS_PRICE_GWEI =
      exports.DEFAULT_GAS_PRICES =
      exports.GAS_PRICE_API =
      exports.MAX_BIOME =
      exports.MIN_BIOME =
      exports.MAX_PLANET_LEVEL =
      exports.MIN_PLANET_LEVEL =
      exports.MAX_ARTIFACT_RARITY =
      exports.MIN_ARTIFACT_RARITY =
      exports.MAX_SPACESHIP_TYPE =
      exports.MIN_SPACESHIP_TYPE =
      exports.MAX_ARTIFACT_TYPE =
      exports.MIN_ARTIFACT_TYPE =
      exports.EMPTY_ARTIFACT_ID =
      exports.EMPTY_LOCATION_ID =
      exports.EMPTY_ADDRESS =
      exports.LOCATION_ID_UB =
      exports.DEFAULT_MAX_CALL_RETRIES =
      exports.CONTRACT_PRECISION =
        void 0;
    var types_1 = require_dist();
    var big_integer_1 = __importDefault(require_BigInteger());
    exports.CONTRACT_PRECISION = 1e3;
    exports.DEFAULT_MAX_CALL_RETRIES = 12;
    exports.LOCATION_ID_UB = (0, big_integer_1.default)(
...
var require_location = __commonJS({
  "node_modules/@darkforest_eth/serde/dist/location.js"(exports) {
    ...
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.locationIdToDecStr =
      exports.locationIdFromEthersBN =
      exports.locationIdFromBigInt =
      exports.locationIdFromDecStr =
      exports.locationIdFromHexStr =
        void 0;
...
var require_artifact2 = __commonJS({
  "node_modules/@darkforest_eth/serde/dist/artifact.js"(exports) {
    ...
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.decodeArtifact =
      exports.decodeArtifactPointValues =
      exports.artifactIdToDecStr =
      exports.artifactIdFromEthersBN =
      exports.artifactIdFromDecStr =
      exports.artifactIdFromHexStr =
        void 0;
    var types_1 = require_dist();
    var big_integer_1 = __importDefault(require_BigInteger());
    ...
    function decodeArtifactPointValues(rawPointValues) {
      return {
        [types_1.ArtifactRarity.Unknown]:
          rawPointValues[types_1.ArtifactRarity.Unknown].toNumber(),
        [types_1.ArtifactRarity.Common]:
          rawPointValues[types_1.ArtifactRarity.Common].toNumber(),
        [types_1.ArtifactRarity.Rare]:
          rawPointValues[types_1.ArtifactRarity.Rare].toNumber(),
        [types_1.ArtifactRarity.Epic]:
          rawPointValues[types_1.ArtifactRarity.Epic].toNumber(),
        [types_1.ArtifactRarity.Legendary]:
          rawPointValues[types_1.ArtifactRarity.Legendary].toNumber(),
        [types_1.ArtifactRarity.Mythic]:
          rawPointValues[types_1.ArtifactRarity.Mythic].toNumber(),
      };
    }
    ...
    function decodeArtifact(rawArtifactWithMetadata) {
      ...
      return {
        ...
        planetDiscoveredOn: (0, location_1.locationIdFromDecStr)(
        ...
        wormholeTo: artifact.wormholeTo.eq(0)
          ? void 0
          : (0, location_1.locationIdFromEthersBN)(artifact.wormholeTo),
        ...
        onPlanetId: locationId.eq(0)
          ? void 0
          : (0, location_1.locationIdFromEthersBN)(locationId),
  ...
  "node_modules/@darkforest_eth/serde/dist/arrival.js"(exports) {
    ...
    function decodeArrival(rawArrival) {
      const arrival = {
        ...
        fromPlanet: (0, location_1.locationIdFromDecStr)(
          rawArrival.fromPlanet.toString()
        ),
        toPlanet: (0, location_1.locationIdFromDecStr)(
          rawArrival.toPlanet.toString()
        ),
        energyArriving:
          rawArrival.popArriving.toNumber() / constants_1.CONTRACT_PRECISION,
        silverMoved:
          rawArrival.silverMoved.toNumber() / constants_1.CONTRACT_PRECISION,
        ...
        artifactId: rawArrival.carriedArtifactId.eq(0)
          ? void 0
          : (0, artifact_1.artifactIdFromEthersBN)(
              rawArrival.carriedArtifactId
            ),
      };
      return arrival;
    }
  ...
  "node_modules/@darkforest_eth/serde/dist/event.js"(exports) {
    ...
    function isNetworkEvent(event) {
      return (
        ...
        (event.autoGasPriceSetting === void 0 ||
          Object.values(types_1.AutoGasSetting).includes(
            event.autoGasPriceSetting
          ))
      );
    }
...
var require_dist3 = __commonJS({
  "node_modules/@darkforest_eth/hexgen/dist/index.js"(exports) {
    ...
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.planetHasBonus =
      exports.bonusFromHex =
      exports.getBytesFromHex =
        void 0;
    var big_integer_1 = __importDefault(require_BigInteger());
...
var require_planet2 = __commonJS({
  "node_modules/@darkforest_eth/serde/dist/planet.js"(exports) {
    ...
    function decodePlanet(
      ...
      const locationId = (0, location_1.locationIdFromDecStr)(
      ...
      const planet = {
        ...
        energyCap:
          rawPlanet.populationCap.toNumber() / constants_1.CONTRACT_PRECISION,
        energyGrowth:
          rawPlanet.populationGrowth.toNumber() /
          constants_1.CONTRACT_PRECISION,
        silverCap:
          rawPlanet.silverCap.toNumber() / constants_1.CONTRACT_PRECISION,
        silverGrowth:
          rawPlanet.silverGrowth.toNumber() / constants_1.CONTRACT_PRECISION,
        energy:
          rawPlanet.population.toNumber() / constants_1.CONTRACT_PRECISION,
    ...
    function decodePlanetDefaults(rawDefaults) {
      return {
        populationCap: rawDefaults.map(
          (x) => x[1].toNumber() / constants_1.CONTRACT_PRECISION
        ),
        populationGrowth: rawDefaults.map(
          (x) => x[2].toNumber() / constants_1.CONTRACT_PRECISION
        ),
        range: rawDefaults.map((x) => x[3].toNumber()),
        speed: rawDefaults.map((x) => x[4].toNumber()),
        defense: rawDefaults.map((x) => x[5].toNumber()),
        silverGrowth: rawDefaults.map(
          (x) => x[6].toNumber() / constants_1.CONTRACT_PRECISION
        ),
        silverCap: rawDefaults.map(
          (x) => x[7].toNumber() / constants_1.CONTRACT_PRECISION
        ),
  ...
  "node_modules/@darkforest_eth/serde/dist/player.js"(exports) {
    ...
    function decodePlayer(rawPlayer) {
      return {
        ...
        homePlanetId: (0, location_1.locationIdFromEthersBN)(
          rawPlayer.homePlanetId
        ),
...
var require_transactions2 = __commonJS({
  "node_modules/@darkforest_eth/serde/dist/transactions.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.isUnconfirmedCapturePlanetTx =
      exports.isUnconfirmedInvadePlanetTx =
      exports.isUnconfirmedGetShipsTx =
      exports.isUnconfirmedWithdrawSilverTx =
      exports.isUnconfirmedDeactivateArtifactTx =
      exports.isUnconfirmedActivateArtifactTx =
      exports.isUnconfirmedProspectPlanetTx =
      exports.isUnconfirmedWithdrawArtifactTx =
      exports.isUnconfirmedDepositArtifactTx =
      exports.isUnconfirmedFindArtifactTx =
      exports.isUnconfirmedTransferTx =
      exports.isUnconfirmedBuyHatTx =
      exports.isUnconfirmedUpgradeTx =
      exports.isUnconfirmedReleaseTx =
      exports.isUnconfirmedMoveTx =
      exports.isUnconfirmedInitTx =
      exports.isUnconfirmedRevealTx =
      exports.isUnconfirmedInvadePlanet =
      exports.isUnconfirmedCapturePlanet =
      exports.isUnconfirmedGetShips =
      exports.isUnconfirmedWithdrawSilver =
      exports.isUnconfirmedDeactivateArtifact =
      exports.isUnconfirmedActivateArtifact =
      exports.isUnconfirmedProspectPlanet =
      exports.isUnconfirmedWithdrawArtifact =
      exports.isUnconfirmedDepositArtifact =
      exports.isUnconfirmedFindArtifact =
      exports.isUnconfirmedTransfer =
      exports.isUnconfirmedBuyHat =
      exports.isUnconfirmedUpgrade =
      exports.isUnconfirmedRelease =
      exports.isUnconfirmedMove =
      exports.isUnconfirmedInit =
      exports.isUnconfirmedReveal =
        void 0;
...
var niceErrors = {
  ...
  17: function _2(index, length) {
    return (
      "[mobx.array] Index out of bounds, " + index + " is larger than " + length
    );
  },
...
var getOwnPropertyDescriptors =
  ...
  function getOwnPropertyDescriptors2(target) {
    var res = {};
...
function storeAnnotation(prototype, key, annotation) {
  ...
  if (
    ...
    !hasProp(prototype[storedAnnotationsSymbol], key)
  ) {
...
function assertNotDecorated(prototype, annotation, key) {
  if (
    ...
    var currentAnnotationType =
      prototype[storedAnnotationsSymbol][key].annotationType_;
  ...
  return {
    value: createAction(
      ...
      (_annotation$options_$2 =
        ...
        ? _annotation$options_$2
        : false,
      (_annotation$options_4 = annotation.options_) != null &&
        _annotation$options_4.bound
...
var observableAnnotation =
  /* @__PURE__ */ createObservableAnnotation(OBSERVABLE);
...
var observableDecoratorAnnotation =
  /* @__PURE__ */ createDecoratorAnnotation(observableAnnotation);
...
var observableFactories = {
  ...
  shallow: /* @__PURE__ */ createDecoratorAnnotation(
    observableShallowAnnotation
  ),
...
var computedStructAnnotation = /* @__PURE__ */ createComputedAnnotation(
  COMPUTED_STRUCT,
  {
...
computed.struct = /* @__PURE__ */ createDecoratorAnnotation(
  computedStructAnnotation
);
...
var isFunctionNameConfigurable =
  (_getDescriptor$config =
    (_getDescriptor = /* @__PURE__ */ getDescriptor(function () {}, "name")) ==
    null
      ? void 0
...
var ObservableValue = /* @__PURE__ */ (function (_Atom, _Symbol$toPrimitive2) {
  ...
  _proto.prepareNewValue_ = function prepareNewValue_(newValue) {
    ...
    return this.equals(this.value_, newValue)
...
var isObservableValue = /* @__PURE__ */ createInstanceofPredicate(
  "ObservableValue",
  ObservableValue
);
...
var ComputedValue = /* @__PURE__ */ (function (_Symbol$toPrimitive2) {
  function ComputedValue2(options) {
    ...
    this.name_ =
      options.name || (true ? "ComputedValue@" + getNextId() : "ComputedValue");
    if (options.set) {
      this.setter_ = createAction(
        true ? this.name_ + "-setter" : "ComputedValue-setter",
        options.set
      );
    }
    this.equals_ =
...
var isComputedValue = /* @__PURE__ */ createInstanceofPredicate(
  "ComputedValue",
  ComputedValue
);
var IDerivationState_;
(function (IDerivationState_2) {
  IDerivationState_2[(IDerivationState_2["NOT_TRACKING_"] = -1)] =
    "NOT_TRACKING_";
  IDerivationState_2[(IDerivationState_2["UP_TO_DATE_"] = 0)] = "UP_TO_DATE_";
  IDerivationState_2[(IDerivationState_2["POSSIBLY_STALE_"] = 1)] =
    "POSSIBLY_STALE_";
...
var globalState = /* @__PURE__ */ (function () {
  ...
  if (
    global2.__mobxGlobals &&
    global2.__mobxGlobals.version !== new MobXGlobals().version
  ) {
    canMergeGlobalState = false;
  }
...
var Reaction = /* @__PURE__ */ (function () {
  ...
  _proto.reportExceptionInDerivation_ = function reportExceptionInDerivation_(
    error
  ) {
    var _this = this;
...
var isReaction = /* @__PURE__ */ createInstanceofPredicate(
  "Reaction",
  Reaction
);
...
var actionBoundAnnotation = /* @__PURE__ */ createActionAnnotation(
  ACTION_BOUND,
  {
    bound: true,
  }
...
var autoActionBoundAnnotation = /* @__PURE__ */ createActionAnnotation(
  AUTOACTION_BOUND,
  {
    autoAction: true,
    bound: true,
...
autoAction.bound = /* @__PURE__ */ createDecoratorAnnotation(
...
FlowCancellationError.prototype = /* @__PURE__ */ Object.create(
  Error.prototype
);
...
var flow = /* @__PURE__ */ Object.assign(function flow2(arg1, arg2) {
  ...
  var res = function res2() {
    ...
    var gen = action(name + " - runid: " + runId + " - init", generator).apply(
      ctx,
      args
    );
    var rejector;
...
function hasInterceptors(interceptable) {
  return (
    interceptable.interceptors_ !== void 0 &&
    interceptable.interceptors_.length > 0
  );
}
function registerInterceptor(interceptable, handler) {
  var interceptors =
    interceptable.interceptors_ || (interceptable.interceptors_ = []);
...
function hasListeners(listenable) {
  return (
    listenable.changeListeners_ !== void 0 &&
    listenable.changeListeners_.length > 0
  );
}
...
function makeAutoObservable(target, overrides, options) {
  if (true) {
    if (
      ...
      !isPlainObject(Object.getPrototypeOf(target))
    ) {
      die(
...
var ObservableArrayAdministration = /* @__PURE__ */ (function () {
  ...
  _proto.spliceWithArray_ = function spliceWithArray_(
    index,
    deleteCount,
    newItems
  ) {
  ...
  _proto.notifyArraySplice_ = function notifyArraySplice_(
    index,
    added,
    removed
  ) {
...
var ObservableMap = /* @__PURE__ */ (function (
  ...
  function ObservableMap2(initialData, enhancer_, name_) {
    ...
    this.keysAtom_ = createAtom(
      true ? this.name_ + ".keys()" : "ObservableMap.keys()"
    );
    this.data_ = new Map();
  ...
  _proto.addValue_ = function addValue_(key, newValue) {
    ...
    transaction(function () {
      ...
      var observable2 = new ObservableValue(
        newValue,
        _this4.enhancer_,
        true ? _this4.name_ + "." + stringifyKey(key) : "ObservableMap.key",
        false
      );
  ...
  _proto.clear = function clear2() {
    ...
    transaction(function () {
      untracked(function () {
        for (
          var _iterator2 = _createForOfIteratorHelperLoose(_this6.keys()),
            _step2;
  ...
  _proto.replace = function replace2(values) {
    ...
    transaction(function () {
      ...
      for (
        var _iterator3 = _createForOfIteratorHelperLoose(_this7.data_.keys()),
          _step3;
...
var isObservableMap = /* @__PURE__ */ createInstanceofPredicate(
  "ObservableMap",
  ObservableMap
);
...
var isObservableSet = /* @__PURE__ */ createInstanceofPredicate(
  "ObservableSet",
  ObservableSet
);
...
var ObservableObjectAdministration = /* @__PURE__ */ (function () {
  function ObservableObjectAdministration2(
    target_,
    values_,
    name_,
    defaultAnnotation_
    ...
    this.keysAtom_ = new Atom(
      true ? this.name_ + ".keys" : "ObservableObject.keys"
    );
  ...
  _proto.setObservablePropValue_ = function setObservablePropValue_(
    key,
    newValue
  ) {
  ...
  _proto.make_ = function make_(key, annotation) {
    ...
    if (!(key in this.target_)) {
      ...
      if (
        (_this$target_$storedA = this.target_[storedAnnotationsSymbol]) !=
          null &&
  ...
  _proto.defineProperty_ = function defineProperty_(
    key,
    descriptor,
    proxyTrap
  ) {
  ...
  _proto.defineObservableProperty_ = function defineObservableProperty_(
    ...
    try {
      ...
      var observable2 = new ObservableValue(
        value,
        enhancer,
        true ? this.name_ + "." + key.toString() : "ObservableObject.key",
        false
      );
  ...
  _proto.defineComputedProperty_ = function defineComputedProperty_(
    key,
    options,
    proxyTrap
  ) {
  ...
  _proto.delete_ = function delete_(key, proxyTrap) {
    ...
    try {
      ...
      if (!observable2 && (notify || notifySpy)) {
        var _getDescriptor2;
        value =
          (_getDescriptor2 = getDescriptor(this.target_, key)) == null
            ? void 0
            : _getDescriptor2.value;
      }
      if (proxyTrap) {
  ...
  _proto.notifyPropertyAddition_ = function notifyPropertyAddition_(
    key,
    value
  ) {
    ...
    (_this$pendingKeys_2 = this.pendingKeys_) == null
      ...
      ? void 0
      : _this$pendingKeys_2$g.set(true);
    this.keysAtom_.reportChanged();
  };
...
function asObservableObject(target, options) {
  ...
  if (hasProp(target, $mobx)) {
    if (
      !(getAdministration(target) instanceof ObservableObjectAdministration)
    ) {
      die(
        "Cannot convert '" +
          getDebugName(target) +
...
var isObservableObjectAdministration =
  /* @__PURE__ */ createInstanceofPredicate(
...
var LegacyObservableArray = /* @__PURE__ */ (function (
  _StubArray,
  _Symbol$toStringTag2,
  _Symbol$iterator2
) {
...
function getAtom(thing, property) {
  if (typeof thing === "object" && thing !== null) {
    ...
    if (isObservableMap(thing)) {
      ...
      var observable2 =
        thing.data_.get(property) || thing.hasMap_.get(property);
      if (!observable2) {
  ...
  return {
    ...
    deposit: (artifactId) => {
      return core["safeTransferFrom(address,address,uint256)"](
        df.getAccount(),
        DEPO_ADDRESS,
        (0, import_serde.artifactIdToDecStr)(artifactId)
      );
    },
    withdraw: (artifactId) => {
      return depo.withdrawArtifact(
        (0, import_serde.artifactIdToDecStr)(artifactId)
      );
    },
    onWithdraw: () => {},
...
function getArtifactDepositRow(artifact, executeDeposit, forceRefresh) {
  const row = Row();
  row.append(
    (document.createElement("text").innerHTML = `${(0,
    import_types.artifactNameFromArtifact)(artifact)} ${
      import_types.ArtifactRarityNames[artifact.rarity]
    } ${import_types.ArtifactTypeNames[artifact.artifactType]}`)
  );
...
function getArtifactWithdrawRow(artifact, executeWithdrawl) {
  ...
  row.append(
    (document.createElement("text").innerHTML = `${(0,
    import_types2.artifactNameFromArtifact)(artifact)} ${
      import_types2.ArtifactRarityNames[artifact.rarity]
    } ${import_types2.ArtifactTypeNames[artifact.artifactType]}`)
  );
...
var buildWithdrawlPane = (container, depoArtifacts, executeWithdrawl) => {
  depoArtifacts
    .filter((a) => !!a)
    .map((a) => getArtifactWithdrawRow(a, executeWithdrawl))
    .forEach((r) => container.append(r));
};
...
export { Depo_default as default };
