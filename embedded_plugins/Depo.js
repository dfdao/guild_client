    ...
    var bigInt = (function (undefined2) {
      ...
      function randBetween(a, b, rng) {
        ...
        for (var i2 = 0; i2 < digits.length; i2++) {
          var top = restricted
            ? digits[i2] + (i2 + 1 < digits.length ? digits[i2 + 1] / BASE : 0)
            : BASE;
...
var require_dist3 = __commonJS({
  "node_modules/@darkforest_eth/hexgen/dist/index.js"(exports) {
    ...
    var bonusById = /* @__PURE__ */ new Map();
...
// plugins/depo/lib.ts
var import_serde = __toESM(require_dist4());
  ...
  const eventHandlers = {
    ["Deposit"]: (addr, rawArtifactId) => {
      df.hardRefreshArtifact(
        (0, import_serde.artifactIdFromEthersBN)(rawArtifactId)
      );
      console.log(
        `${(0, import_serde.artifactIdFromEthersBN)(
          rawArtifactId
        )} was deposited`
      );
    },
    ["Withdrawl"]: (addr, rawArtifactId) => {
      console.log(
        `artifact ${(0, import_serde.artifactIdFromEthersBN)(
          rawArtifactId
        )} was withdrawn`
      );
    },
