(() => {
  ...
  var import_types = __toModule(__require("https://cdn.skypack.dev/@darkforest_eth/types"));
  var import_procedural = __toModule(__require("https://cdn.skypack.dev/@darkforest_eth/procedural"));
  var import_serde = __toModule(__require("https://cdn.skypack.dev/@darkforest_eth/serde"));
  var import_standalone_module = __toModule(__require("https://unpkg.com/htm/preact/standalone.module.js"));
  var import_utils = __toModule(__require("https://plugins.zkga.me/utils/utils.js"));
